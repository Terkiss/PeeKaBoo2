...
public class DataBaseInfo {
    ...
    public static final String _CreateRoomTable = "Create table if not exists roomTBL(_id integer, roomName varchar(100), maxJoin varchar(60), roomTag varchar(200), joinPassword varchar(100), superUser varchar(100), PRIMARY KEY(_id AUTOINCREMENT))";
