...
namespace PeeKaBoo.DataBase
{
    class DataBaseInfo
    {
        ...
        public static string CreateChatTable = "CREATE TABLE IF NOT EXISTS chatTBL(_id	INTEGER, roomName	varchar(100), sender	varchar(100), comment	varchar(200), chatTime	varchar(10), PRIMARY KEY(_id AUTOINCREMENT))";
